...
RequestManager.providers = {
    WebsocketProvider: require('@fundament/web3-providers-ws'),
    HttpProvider: require('@fundament/web3-providers-http'),
    IpcProvider: require('@fundament/web3-providers-ipc')
};
